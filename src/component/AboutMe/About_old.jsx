    ...
    <div className="about-container">
      <div className="about-main">
        ...
        <div className="about-body">
          <div className="about-text">
            <p>
              I am an undergrad Information Technology student who is intrigued
              by development on the web with a knack for Frontend.I am currently
              working on my UI / UX skills and absorbing newer design tools.
              Creating & learning by the day, I aspire to become an excellent
              full stack developer among alot of other things;)
            </p>
          </div>
      ...
      <div id="icons-div">
        <div className="details-icons">
          ...
          <a
            target="_blank"
            href="https://www.linkedin.com/in/radhika-kakkar-bb6824193"
          >
